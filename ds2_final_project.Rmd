...
airbnb_data = airbnb_initial%>%
  mutate(boro = as.numeric(as.factor(boro)),
        neighbourhood = as.numeric(as.factor(airbnb_data$neighbourhood)),
        as.numeric(as.factor(airbnb_data$room_type)))
...
test_error4 = mean((pcr.pred-y[-trRows])^2)
```
...
test_error5 = mean((pls.pred-y[-trRows])^2)
```
