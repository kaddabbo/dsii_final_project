...
#why filtering from 30 to 500? 
#do we need name, lat & long
...
predict(fit_price, newdata = airbnb[-train_price_tree,])
...
predict(ctree_price, newdata = airbnb[-train_price_tree,])
